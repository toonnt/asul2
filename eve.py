...
cl = ASUL.LINE()
#cl.login(qr=True)
cl.login(token="EoeMCOD3kdfPrlkZqBh6.xxD+zgW3gaYtM/L6PqLWLG.6+XoMx1PTi9GI6Vohhw/dIpAwRb6PyOITj5Nx++JuBw=")
cl.loginResult()

ki = ASUL.LINE()
#ki.login(qr=True)
ki.login(token="EnRvhUbVH46dZ8QCuXHf.rQhtuu7bBHiReAU3hF45NW.sooFEJdzzH4VQRsd4f9XpKTO+jEEM0uo4Fm1NWhyV/E=")
ki.loginResult()

ki2 = ASUL.LINE()
#ki.login(qr=True)
ki2.login(token="En2B5qVVZRtAyMnkQbh1.KaptOybxCrifYDMnQKDtuq.lgZuSxbGikXtGXbC52o2ejkRazDtl2gLdgqUWmObMWk=")
ki2.loginResult()
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"ปิดระบบตอบกลับอัตโนมัต")
